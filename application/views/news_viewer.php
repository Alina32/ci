                ...
                <?php foreach ($latest_news as $article): ?>
                	<div class="col-md-4">
                	    <div class="panel panel-default">
                	        ...
                	        <div class="panel-body">
                	            <div class="news_dtd">
                	                <p><?=$article['date']?> by <a href="#"><?=$article['author']?></a></p>
                	            </div>
                	            <h3 class="sec_titl"><?=$article['title']?></h3>
                	            <p class="sec_desc"><?=$article['description']?></p>
                	            <p class="readmore text-left"><a href="/news/single_news/<?=$article['id']?>">Read More</a></p>
                	        </div>
                	    </div>
                	</div>
		        <?php endforeach ?>
